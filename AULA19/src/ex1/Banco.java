                ...
                case '1' -> {
                    for (int c = 0; c < 10; c++) {
                        if (c == cont) {
                            ...
                            conta[c].titular = ler.next();
                            System.out.print("Digite o identificador: ");
                            conta[c].identificador = ler.next();
                            System.out.print("Digite a senha: ");
                            conta[c].senha = ler.next();
                            System.out.print("Digite o saldo inicial: ");
                            conta[c].saldo = ler.nextFloat();
                        ...
                        if (idres.equals(conta[c].identificador)) {
                            ...
                            do {
                                ...
                                switch (res) {
                                    ...
                                    case '3' -> {
                                        System.out.println("O saldo de "+conta[c].titular+" atual é R$" + conta[c].saldo);
                                    }
